...
public class PaginationDto {
    ...
    public PaginationDto(@Min(value = 0, message = "La página debe ser mayor o igual a 0") int page,
            @Min(value = 1, message = "El tamaño debe ser mayor o igual a 1") @Max(value = 100, message = "El tamaño no debe superar 100 registros") int size,
